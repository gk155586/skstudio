...
export default function MaternitySegmentPage() {
  const segments = [
    {
      title: "Indoor Maternity",
      href: "/services/maternity-indoor",
      image: "/img/gallery/maternity-indoor/maternity-indoor-cover.jpeg",
      desc: "Elegant pregnancy portraiture showcasing the journey of motherhood in premium gown collections in our climate-controlled studio.",
    },
    {
      title: "Outdoor Maternity",
      href: "/services/maternity-outdoor",
      image: "/img/gallery/maternity-outdoor/1/SKO00321.JPG",
      desc: "Scenic, glowing natural light maternity portraits captured at Pune's most beautiful lakes and custom private farms.",
    },
  ];
      ...
      <main className="pt-28 md:pt-32 pb-20 px-4 md:px-12 max-w-7xl mx-auto flex flex-col gap-8 md:gap-12">
        ...
        <div className="flex flex-col gap-2 md:gap-3 max-w-2xl">
          ...
          <p className="text-gray-600 dark:text-gray-300 text-sm md:text-base leading-relaxed font-light">
            An elegant, premium pregnancy photo session. Choose between our fully setup indoor studio or glowing sunset outdoor locations.
          </p>
        </div>
